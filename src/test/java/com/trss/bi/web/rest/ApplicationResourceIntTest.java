...
public class ApplicationResourceIntTest {
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getPreview()).isEqualTo(DEFAULT_PREVIEW);
        assertThat(testApplication.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testApplication.getLink()).isEqualTo(DEFAULT_LINK);
    }
    ...
    @Test
    @Transactional
    public void checkPreviewIsRequired() throws Exception {
        int databaseSizeBeforeTest = applicationRepository.findAll().size();
        // set the field null
        application.setPreview(null);
    ...
    public void getAllApplications() throws Exception {
        application = ApplicationResourceIntTest.createEntity(em);
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].preview").value(hasItem(DEFAULT_PREVIEW.toString())))
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.preview").value(DEFAULT_PREVIEW.toString()))
    ...
    public void updateApplication() throws Exception {
        ...
        assertThat(testApplication.getPreview()).isEqualTo(UPDATED_PREVIEW);
        assertThat(testApplication.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testApplication.getLink()).isEqualTo(UPDATED_LINK);
    }
