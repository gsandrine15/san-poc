...
public class AccountResourceIntTest {
    ...
    @Mock
    private UserWithDetailService mockUserWithDetailService;
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, userWithDetailService, mockMailService, applicationProperties);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockUserWithDetailService, mockMailService, applicationProperties);
...
//    @Ignore("unable to verify IT")
    public void testGetExistingAccount() throws Exception {
        ...
        user.setLangKey("en");
        user.setRole(role);
        when(mockUserService.getUserWithRole()).thenReturn(Optional.of(user));
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.role").value(AuthorizationConstants.ADMIN));
    }

    @Test
    public void testGetUnknownAccount() throws Exception {
        when(mockUserService.getUserWithRole()).thenReturn(Optional.empty());
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthorizationConstants.CLIENT_VIEW_ONLY_USER));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthorizationConstants.CLIENT_VIEW_ONLY_USER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
//        validUser.setRole(AuthorizationConstants.ADMIN);
...
//        assertThat(userDup.get().getRole().getName()).isEqualTo("ADMIN");
    }
    ...
    public void testSaveInvalidEmail() throws Exception {
        ...
        userDTO.setImageUrl("http://placehold.it/50x50");
        userDTO.setLangKey(Constants.DEFAULT_LANGUAGE);
        userDTO.setAuthorities(Collections.singleton(AuthorizationConstants.ADMIN));
    ...
    public void testChangePassword() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password").contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "new Password1234!@#$"))))
                .andExpect(status().isOk());

        User updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
        assertThat(passwordEncoder.matches("new Password1234!@#$", updatedUser.getPassword())).isTrue();
    }
    ...
    public void testFinishPasswordReset() throws Exception {
        ...
        keyAndPassword.setNewPassword("new Password1234!@#$");
