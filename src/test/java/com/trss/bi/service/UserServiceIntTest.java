...
public class UserServiceIntTest {
    ...
    public void assertThatResetKeyMustNotBeOlderThan24Hours() {
        ...
        Optional<User> maybeUser = userService.completePasswordReset("johndoe2!@#$G", user.getResetKey());
        assertThat(maybeUser).isNotPresent();
        userRepository.delete(user);
    }
    ...
    @Test
    @Transactional
    public void assertThatPasswordComplexityRequired() {
        thrown.expect(InvalidPasswordException.class);
        thrown.expectMessage(is("New password does not meet complexity requirements."));
